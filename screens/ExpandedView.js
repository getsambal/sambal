...
const data = {
  data_: {
    image:
      'https://img.grouponcdn.com/seocms/swZZyUMNMcZ84TUGjiQLLq/malaysian-food_hero-600x390.jpg',
    desc: 'Food desc...',
    price: 'RM 4.50 - 6.00',
    name: 'Nasi Lemak',
...
export default class ExpandedView extends Component {
  ...
  _handlePressDirections = () => {
    let { address, postalCode, city } = this.state;
          ...
          >
            ...
            <View
              style={{
                ...
                minHeight: Layout.window.height - 370,
              }}
            >
